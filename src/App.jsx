    ...
    <main className="min-h-screen bg-gray-100 px-4 py-6 text-slate-900 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="rounded-[2rem] border border-white/10 bg-slate-950 p-5 text-white shadow-[0_35px_100px_-55px_rgba(15,23,42,0.9)]">
          ...
          <button
  type="button"
  onClick={saveQuoteAndPrint}
  className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#C51605] px-6 py-3 text-sm font-black text-white shadow-lg shadow-[#C51605]/25 transition hover:bg-[#A91204]"
>
